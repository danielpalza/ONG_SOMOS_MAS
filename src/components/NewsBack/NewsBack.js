                    ...
                    <tbody>
                        ...
                        {this.state.data.map((element) => (
                            <tr>
                                ...
                                <td><Button onClick = {this.handleEdit} color='primary'>Edit</Button>{'  '}
                                <Button onClick = {this.deleteNew(element.id)}  color='danger'>Delete</Button></td>
                            </tr>
                        ))}
                    </tbody>
                </Table>
