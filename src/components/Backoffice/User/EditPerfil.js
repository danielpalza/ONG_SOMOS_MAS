...
const EditProfile = (props) =>{
    ...
    const [info, setInfo] = useState({
        password: props.password || '12345',
        email : props.email || 'nahuelsan96@gmail.com'
    })
    ...
    useEffect(() =>{
        axios.post('http://localhost:3001/auth/login',{password: info.password, email: info.email })
                ...
                }
                {
                    ...
                    <div>
                        <form className={s.form}>
                            ...
                            <input placeholder="Ingrese contraseña actual"/>
                            <label>Contraseña nueva</label>
                            <input placeholder="Ingrese nueva contraseña"/>
                            <label>Repetir contraseña</label>
                            <input placeholder="Repetir contraseña nueva"/>
                        </form>
                        <button> Aceptar </button>
                        <button onClick={() => changeTo()}> Cancelar </button>
                    </div>
                }
            </div>
        </div>
