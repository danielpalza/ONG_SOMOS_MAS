...
import { failFetch, selectFetch, setLoading } from '../../features/fetch/fetchSlice'
            ...
            {fetch.loading ?
                ...
                >
                    ...
                    <Form className="container d-flex flex-column">
                        ...
                        {isModeEdit && (<button className="btn btn-outline-primary" onClick={handleOnCancel} >
                            Cancel
                        </button>)}
